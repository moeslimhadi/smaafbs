...
<head>
    ...
    <title>FORM PENDAFTARAN PPDB ONLINE - SMA Al Furqon Boarding School (AFBS)</title>
    <!--[if IE 8]>
            ...
            <div class="tz-slider-banner">
                <div class="tz-items">
                    <div class="tz-slider-images">
                        <img src="demos/Banner/afbs_terang.jpg" alt="Images">
                    </div>
                    <div class="tz-banner-content">
                        <div class="container">
                            <!-- <small>NUMBER ONE</small> -->
                            <h4>SMA Al Furqon Boarding School (AFBS)</h4>
            ...
            <div class="container" id="fc">
                <div class="row">
                    ...
                    <div class="tz-map-us">
                        ...
                        Lengkapi Form Regristasi Pendaftar Calon Siswa Baru<hr />
                        ...
                        <div align="justify"><font size="-2">* Disarankan email diisi dengan email yang aktif, karena informasi akan dikirim via email</font></div>
                        <br /><br />
                    </div>
                </div>
            </div>
