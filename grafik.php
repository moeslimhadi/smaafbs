...
<head>
    ...
    <title>KUMPULAN GRAFIK - SMA Al Furqon Boarding School (AFBS)</title>
    <!--[if IE 8]>
    ...
    <section class="tz-introduce-univesity">
        ...
        <div class="tzWrap">
            ...
            <div class="container" id="fc">
                <div class="row">
                    <div class="tz-map-us">
                        <h3><a href="#">GRAFIK SMA Al Furqon Boarding School (AFBS)</a></h3>
                        Grafik Calon Siswa Baru SMA Al Furqon Boarding School (AFBS) terdiri dari pilihan kelas, jumlah pendaftar dan jumlah gender<hr />
